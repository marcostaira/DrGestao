...
export default function NovaAnamneseAtendimentoPage() {
    ...
    <div className="px-4 sm:px-6 lg:px-8 py-8 max-w-4xl mx-auto">
      ...
      <div className="mb-6">
        ...
        <h1 className="text-2xl font-bold text-gray-900">
          Nova Anamnese - Atendimento
        </h1>
        <p className="mt-2 text-sm text-gray-700">
          Paciente:{" "}
          <span className="font-medium">{atendimento?.paciente?.nome}</span>
        </p>
      </div>
      ...
      <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
          <div>
            <span className="text-blue-700">Profissional:</span>
            <p className="font-medium text-blue-900">
              {atendimento?.profissional?.nome}
            </p>
          </div>
          <div>
            <span className="text-blue-700">Procedimento:</span>
            <p className="font-medium text-blue-900">
